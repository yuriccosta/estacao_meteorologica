...
".panel{background-color:#161b22;border:1px solid #30363d;border-radius:6px;padding:15px;flex:1;min-width:300px;}"
".panel-title{font-size:1.1rem;color:#58a6ff;margin:0 0 15px 0;border-bottom:1px solid #30363d;padding-bottom:10px;}"
".sensor-group{margin-bottom:15px;}.sensor-group-title{font-size:0.9rem;color:#8b949e;margin-bottom:10px;}"
".readings-grid{display:flex;gap:10px;}"
".reading-card{background-color:#0d1117;padding:10px;border-radius:6px;text-align:center;flex:1;}"
".reading-card .label{font-size:0.8rem;color:#8b949e;}.reading-card .value{font-size:1.2rem;font-weight:600;color:#c9d1d9;}"
".form-group{margin-bottom:10px;}.form-group label{display:block;font-size:0.8rem;color:#8b949e;margin-bottom:4px;}"
".input-row{display:flex;gap:10px;}.input-row input{width:100%;background-color:#010409;border:1px solid #30363d;color:#c9d1d9;border-radius:6px;padding:8px;font-size:0.9rem;}"
".btn-submit{width:100%;background-color:#238636;color:#fff;border:1px solid #2ea043;padding:10px;font-size:1rem;border-radius:6px;cursor:pointer;margin-top:10px;}"
"#notification{text-align:center;padding:8px;border-radius:6px;margin-top:10px;font-weight:600;display:none;}"
"#notification.success{background-color:#238636;}#notification.error{background-color:#da3633;}"
...
"<div class='sensor-group'><p class='sensor-group-title'>Sensor 1 (AHT20)</p>"
"<div class='readings-grid'>"
"<div class='reading-card'><p class='label'>Temperatura</p><p class='value' id='s1_temp'>-- °C</p></div>"
"<div class='reading-card'><p class='label'>Umidade</p><p class='value' id='s1_humidity'>-- %</p></div>"
"</div></div>"
"<div class='sensor-group'><p class='sensor-group-title'>Sensor 2 (BMP280)</p>"
"<div class='readings-grid'>"
"<div class='reading-card'><p class='label'>Temperatura</p><p class='value' id='s2_temp'>-- °C</p></div>"
"<div class='reading-card'><p class='label'>Pressão</p><p class='value' id='s2_pressure'>-- Pa</p></div>"
"</div></div>"
"</div>"
"<div class='panel'>"
...
"</div></div>"
"<div class='form-group'><label>Umidade (%)</label>"
"<div class='input-row'>"
...
"</div></div>"
"<div class='form-group'><label>Pressão (Pa)</label>"
"<div class='input-row'>"
...
"function initCharts(){"
"const commonOptions={chart:{height:250,type:'line',animations:{enabled:true,easing:'linear',dynamicAnimation:{speed:1000}},toolbar:{show:false},zoom:{enabled:false}},stroke:{curve:'smooth',width:2},theme:{mode:'dark'},tooltip:{theme:'dark'},xaxis:{type:'datetime',range:MAX_DATA_POINTS*5000,labels:{style:{colors:'#8b949e'}}},grid:{borderColor:'#30363d'},legend:{labels:{colors:'#c9d1d9'}}};"
...
"pressureChart=createChart('#pressureChart',{...commonOptions,series:[{name:'Pressão S2 (Pa)',data:[]}],yaxis:{title:{text:'Pa',style:{color:'#8b949e'}},labels:{style:{colors:'#8b949e'}}}});"
"}"
